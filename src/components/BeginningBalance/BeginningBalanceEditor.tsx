...
const BeginningBalanceEditor: React.FC<BeginningBalanceEditorProps> = ({
  currentBalance,
  isLocked,
  onUpdateBalance,
  onToggleLock,
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-2">
            <h3 className="text-sm font-medium text-gray-900">Beginning Balance</h3>
            {isLoading && (
...
export default BeginningBalanceEditor;